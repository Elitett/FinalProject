...
CREATE TABLE names (
fullNameID int NOT NULL AUTO_INCREMENT,
fullName varchar (200) NOT NULL,
password varchar (100) NOT NULL, 
email varchar (100) NOT NULL,
PRIMARY KEY (fullNAmeID, fullName, email)
);

CREATE TABLE teamMembers (
teamID int NOT NULL REFERENCES team (teamID),
fullNameID int NOT NULL REFERENCES names (fullNameID),
PRIMARY KEY (teamID, fullNameID)
);
...
teamID int NOT NULL REFERENCES team (teamID), 
questionID int,
teamNameWin varchar(200),
teamNameLoos varchar(200),
...
INSERT INTO questions (question, hint1, hint2, answer)
VALUES ('This festival has been held since 1873, and it is a part of the UNESCO Masterpieces of the Oral and Intangible Heritage of Humanity list since 2008', 'First held in Dikļi', 'It is one of the largest amateur events of this kind in the world', 'Latvian Song and Dance festival');
INSERT INTO questions (question, hint1, hint2, answer)
...
INSERT INTO questions (question, hint1, hint2, answer)
VALUES ('How is nameed cottage cheese dessert from Latvia?', 'From 1994 associate with the crow', 'From 2020 "Name" of this dessert starts manufactured other dairy products and desserts', 'Karums');
INSERT INTO questions (question, hint1, answer)
